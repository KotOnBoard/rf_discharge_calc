...
plot './csv/all_vs_f.csv' using "f":"d1h_b_ar" with lines dt 1 lw 2 lc "red" title "v_B Ar", \
	 ...
	 ''			 using "f":"d1h_MoO3_ar" with lines dt 1 lw 2 lc "pink" title "v_M_o_O_3 Ar", \
     ''			 using "f":"d1h_MoO3_ne" with lines dt 2 lw 2 lc "pink" title "v_M_o_O_3 Ne", \
     ''			 using "f":"d1h_MoO3_he" with lines dt 3 lw 2 lc "pink" title "v_M_o_O_3 He"
